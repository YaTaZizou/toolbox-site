    ...
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-8 text-gray-300 leading-relaxed">
        ...
        <section>
          ...
          <ul className="mt-3 space-y-2 text-gray-400 list-disc list-inside">
            <li>L&apos;abonnement Premium est proposé au tarif de <span className="text-white">3,99€/mois</span> (plan mensuel) ou <span className="text-white">29,99€/an</span> (plan annuel, soit 2,50€/mois)</li>
            <li>Le paiement mensuel est prélevé automatiquement chaque mois ; le paiement annuel est prélevé en une seule fois à la souscription puis à chaque renouvellement annuel</li>
            <li>Vous pouvez résilier à tout moment depuis votre espace client</li>
            <li>Aucun remboursement ne sera effectué pour un mois ou une année entamés, sauf dans le délai de 7 jours suivant la souscription (voir garantie satisfait ou remboursé) ou dans le cadre du droit de rétractation légal (article 4bis)</li>
            <li>Les paiements sont sécurisés via Stripe</li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-3">4bis. Droit de rétractation</h2>
          <p>Conformément à l&apos;article L221-18 du Code de la consommation, vous disposez d&apos;un délai de 14 jours calendaires à compter de la souscription pour exercer votre droit de rétractation, sans avoir à justifier votre décision. Pour exercer ce droit, contactez-nous à <span className="text-purple-400">contact@alltoolbox.fr</span>. Remboursement effectué dans les 14 jours suivant votre demande. Ce délai peut être réduit si vous demandez expressément l&apos;exécution du service avant la fin du délai.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-3">5. Utilisation acceptable</h2>
          <p>L&apos;utilisation du service est réservée aux personnes âgées d&apos;au moins 15 ans. La souscription à l&apos;abonnement Premium est réservée aux personnes majeures (18 ans révolus).</p>
          <p className="mt-3">Vous vous engagez à ne pas utiliser ToolBox pour :</p>
          <ul className="mt-3 space-y-2 text-gray-400 list-disc list-inside">
        ...
        <section>
          ...
          <p>Les présentes CGU sont soumises au droit français. En cas de litige non résolu à l&apos;amiable, les tribunaux français seront compétents.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-3">11. Médiation de la consommation</h2>
